...
public static class AddAnthropicApiClientSetup
{
    ...
    {
        var options = configuration.GetSection("Anthropic").Get<AnthropicOptions>() ?? throw new InvalidOperationException("Anthropic configuration section is missing or invalid.");
